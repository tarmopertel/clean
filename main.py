...
template = """
 You are a marketing copywriter with 20 years of experience. You are analyzing customer's background to write personalized service description that only this customer will receive; 
    ...
    USE CASE: write a story in 5 sentences, of an example weekend activity taking into account place of residence {residence} and age {agegroup}, write a story in first person, example " I started my morning in the...";OUTPUT TEXT in Estonian;
"""
...
def update_text_with_example():
    print ("in updated")
    st.session_state.content_input = "different cleaning services"
